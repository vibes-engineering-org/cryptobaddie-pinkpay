...
export async function GET() {
  ...
  const config = {
    accountAssociation: {
      ...
      signature:
        "MHgzYWI1ZDIzNGViY2RiZGM2OTZmOGIzMDQxYzNkZTc3ZTg5ZDBjMGNhYjY3ZmRjZDZiY2EwMDI2YmE3M2ViNTViN2E0YzJjOWUyZjliYWY2MTU1ZGM2NTI0ZGU5ZTIxMmViYzA2YWVlZDAxZTc5OTFlMmY3ODgzODA4MDg1Mjk5ODFj",
    },
    frame: {
      version: "1",
      name: PROJECT_TITLE,
